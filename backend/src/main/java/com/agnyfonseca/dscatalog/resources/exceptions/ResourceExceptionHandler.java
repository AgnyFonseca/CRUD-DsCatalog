package com.agnyfonseca.dscatalog.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(EntityNotFoundException.class) //argumento para saber que tipo de exc. ele vai interceptar
